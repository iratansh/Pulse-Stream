...
const industries = [
  {
    name: "Technology",
    icon: <FaPaintBrush />,
    logos: ["Abstract Circuits", "Pixel Cloud", "Binary Flow"],
  },
  {
    name: "Food & Beverage",
    icon: <FaUtensils />,
    logos: ["Fresh Bites", "Urban Grill", "Golden Spoon"],
  },
  {
    name: "Construction",
    icon: <FaBuilding />,
    logos: ["Solid Foundations", "Iron Beam Co", "Peak Structures"],
  },
  {
    name: "Sustainability",
    icon: <FaSeedling />,
    logos: ["Eco Pulse", "Green Horizon", "Nature Cycle"],
  },
  {
    name: "Startups",
    icon: <FaLightbulb />,
    logos: ["Launch Pad", "Idea Forge", "Next Chapter"],
  },
  {
    name: "Healthcare",
    icon: <FaHeart />,
    logos: ["Life Pulse", "Vital Care", "Pure Wellness"],
  },
  {
    name: "Fashion",
    icon: <FaTshirt />,
    logos: ["Urban Thread", "Silk & Stitch", "Moda Vista"],
  },
  {
    name: "Education",
    icon: <FaBook />,
    logos: ["Bright Minds", "Knowledge Hub", "Future Leaders"],
  },
  {
    name: "Travel",
    icon: <FaPlane />,
    ...
    <div className="hero-wrapper">
      ...
      <main className="content-container" style={{ padding: "4rem 0" }}>
        ...
        <section className="text-container" style={{ marginBottom: "4rem" }}>
          <h1 className="heading" style={{ fontSize: "2.75rem" }}>
            Logo Inspiration Gallery
          </h1>
          <p className="description" style={{ maxWidth: "800px" }}>
            Explore {industries.length}+ industry-specific logo concepts and
            design strategies. Filter by category or search for your niche to
            spark creativity.
          </p>
        </section>
        ...
        <section style={{ padding: "2rem 0" }}>
          ...
          {filteredIndustries.length === 0 && (
            ...
            >
              ...
              >
                No industries found for "{searchTerm}". Try searching broader
                categories.
              </p>
            </div>
          )}
        ...
        <section
          ...
          style={{ background: "transparent", padding: "4rem 0" }}
        >
          <div
            className="example-item"
            style={{
          ...
          >
            ...
            <p
              className="description"
              style={{ color: "#e0f2fe", marginBottom: "2rem" }}
            >
